...
const stripe = STRIPE_CONFIGURED ? new stripe_1.default(STRIPE_SECRET_KEY) : null;
describeIfStripe('Stripe Sandbox E2E Tests', () => {
    ...
    describe('Customer Operations', () => {
        ...
        it('should update customer metadata', async () => {
            ...
            expect(customer.metadata?.subscriptionTier).toBe('starter');
...
//# sourceMappingURL=stripe-sandbox.test.js.map