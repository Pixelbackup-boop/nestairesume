...
describe('Auth API Integration Tests', () => {
    ...
    describe('POST /api/v1/auth/register', () => {
        ...
        it('should return 400 for existing verified email', async () => {
            const existingUser = (0, testUtils_1.createTestUser)({
        ...
        it('should allow re-registration for unverified email', async () => {
            const unverifiedUser = (0, testUtils_1.createTestUser)({
    ...
    describe('GET /api/v1/auth/me', () => {
        ...
        it('should return 401 without auth token', async () => {
            const response = await (0, supertest_1.default)(app_1.default).get('/api/v1/auth/me');
            expect(response.status).toBe(testUtils_1.HTTP_STATUS.UNAUTHORIZED);
        });
