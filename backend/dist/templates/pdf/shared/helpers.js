...
const getContrastText = (bgHex) => {
    const luminance = (0, exports.getLuminance)(bgHex);
 ...
 */
const parseDualColor = (colorStr, defaults = { primary: '#0f172a', secondary: '#facc15' }) => {
    if (!colorStr)
        return defaults;
...
exports.parseDualColor = parseDualColor;
...
const generateThemeFromPrimary = (primaryHex) => ({
    name: 'Custom',
    primary: primaryHex,
...
exports.generateThemeFromPrimary = generateThemeFromPrimary;
// --- Preset Themes ---
...
exports.getGoogleFontUrl = getGoogleFontUrl;
// --- Font Sizes ---
exports.fontSizes = {
    small: {
        name: 'Small',
...
exports.getBackgroundCSS = getBackgroundCSS;
// --- Image Helpers ---
...
exports.getImageBorderRadius = getImageBorderRadius;
// --- ID Type Formatting ---
...
exports.formatIdType = formatIdType;
// --- HTML Escaping ---
...
exports.getLanguageLevel = getLanguageLevel;
