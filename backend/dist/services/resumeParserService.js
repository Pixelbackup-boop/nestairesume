...
exports.parseResume = exports.generateEnhancedResume = exports.detectLinkedInPdf = exports.extractTextFromDocx = exports.extractTextFromPdf = void 0;
...
exports.detectLinkedInPdf = detectLinkedInPdf;
// Map language string to proficiency level
const mapProficiency = (prof) => {
...
const buildEnhancementPrompt = (extractedText, locale) => {
...
const generateEnhancedResume = async (extractedText, locale = 'en') => {
    if (!aiClient) {
        return {
            success: false,
    ...
    try {
        ...
        return {
            ...
            isLinkedIn: (0, exports.detectLinkedInPdf)(extractedText),
        };
    }
    catch (error) {
...
exports.generateEnhancedResume = generateEnhancedResume;
...
const looksLikeResume = (text) => {
    ...
    if (dateMatches)
        score += Math.min(dateMatches.length * 10, 30);
...
const parseResume = async (buffer, mimeType, locale = 'en') => {
    try {
        ...
        if (mimeType === "application/pdf") {
            ...
            extractedText = await (0, exports.extractTextFromDocx)(buffer);
        }
        else {
            return {
                success: false,
        ...
        return await (0, exports.generateEnhancedResume)(extractedText, locale);
    }
    catch (error) {
...
//# sourceMappingURL=resumeParserService.js.map