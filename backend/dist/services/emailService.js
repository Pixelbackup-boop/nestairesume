...
exports.sendEmailChangeVerification = exports.sendPasswordResetEmail = exports.sendVerificationEmail = exports.generateVerificationCode = exports.sendEmail = void 0;
...
const sendEmailChangeVerification = async (newEmail, name, code) => {
    const htmlContent = `
    <!DOCTYPE html>
    <html>
    <head>
