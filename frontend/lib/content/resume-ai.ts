...
const zh: ResumeAIPageContent = {
  meta: { title: 'AI简历制作 | 免费AI简历写作 2026', description: '几分钟内用AI创建简历。免费AI简历工具撰写专业内容，优化ATS，帮你获得更多面试。', keywords: 'ai简历, ai简历制作, ai简历生成器, 人工智能简历, ai简历免费, 智能简历制作器' },
  schemas: { breadcrumbName: 'AI简历', articleHeadline: 'AI简历制作：免费AI简历生成器 2026', articleDescription: '用AI创建简历。免费AI简历工具撰写专业内容，优化ATS，制作能获得面试的简历。', softwareAppName: 'AI简历制作器' },
  hero: { badge: '先进AI驱动', title: '用AI创建简历', titleHighlight: '秒速完成', subtitle: '我们的<strong>AI简历制作器</strong>撰写专业内容，优化ATS系统，帮你创建能获得面试的简历——全部免费。据<a href="https://www.linkedin.com/business/talent/blog/talent-acquisition/how-recruiters-use-ai" target="_blank" rel="noopener noreferrer" class="text-purple-600 hover:underline">LinkedIn研究</a>，招聘人员平均只花7秒看每份简历。让AI让每一秒都有价值。', ctaPrimary: '免费试用AI简历', ctaSecondary: '查看工作原理', trustText: '无需注册 \u00b7 100%免费 \u00b7 AI生成内容' },
  whatIs: { title: '什么是AI简历制作？', description: '<strong>AI简历制作</strong>从根本上改变了你创建简历的方式。不再盯着空白屏幕，我们的AI分析你的经验，理解你的目标职位，生成针对你行业的专业内容。正如<a href="https://www.shrm.org/topics-tools/news/talent-acquisition/ai-rapidly-transforming-how-companies-recruit" target="_blank" rel="noopener noreferrer" class="text-purple-600 hover:underline">人力资源管理协会(SHRM)</a>所强调的，AI正在迅速改变招聘方式——用AI制作的简历已被雇主广泛接受。', stats: [{ value: '10x', label: '比手动写作更快' }, { value: '85%', label: '更高的ATS通过率' }, { value: '3M+', label: '已用AI创建的简历' }] },
  features: { title: 'AI如何改进你的简历', subtitle: 'AI不仅仅是排版——它帮你写出真正更好的内容。', items: [{ title: 'AI内容写作', description: 'AI根据你的经验和目标职位生成专业的工作经验、摘要和技能描述。' }, { title: '智能关键词优化', description: 'AI分析职位描述，建议雇主寻找的行业特定关键词。' }, { title: 'ATS评分分析', description: '实时评分显示你的简历在投递前如何被ATS系统评估。' }, { title: '量化成果', description: 'AI将模糊描述转化为可衡量的具体成就，吸引招聘人员注意。' }, { title: '行业特定模板', description: 'AI建议最适合你行业和经验水平的布局和章节。' }, { title: '语法和语气检查', description: 'AI自动检查语法和拼写，确保无错误的专业呈现。' }] },
  beforeAfter: { title: '看AI如何改变你的简历', subtitle: 'AI改进的真实示例。', beforeLabel: '改进前', afterLabel: 'AI改进后', items: [{ before: '管理团队和项目', after: '领导8人跨职能团队，按时交付12个项目，客户满意度达98%' }, { before: '提高了收入', after: '通过数据驱动的采购策略将年收入提高34%（¥200万）' }, { before: '提供了良好的客户服务', after: '获得4.9/5满意度评分，每日处理150+咨询，首次联系解决率95%' }], cta: '创建专业简历' },
  comparison: { title: 'AI简历vs手动写作', subtitle: '为什么求职者选择AI简历制作。', oursName: '使用AI', othersName: '手动写作', rows: [{ feature: '制作时间', ours: '10-15分钟', others: '2-4小时' }, { feature: '专业写作', ours: 'AI建议', others: '需要自己研究' }, { feature: 'ATS优化', ours: '自动', others: '手动，易出错' }, { feature: '行业关键词', ours: 'AI建议', others: '自己查找' }, { feature: '语法拼写', ours: '自动检查', others: '容易忽略' }, { feature: '量化成果', ours: 'AI帮助', others: '经常遗忘' }, { feature: '排版设计', ours: '20+模板', others: '从零开始' }] },
  useCases: { title: 'AI简历适合谁？', subtitle: '我们的AI简历制作器适合所有求职者。', items: [{ title: '转行者', description: 'AI帮助突出可迁移技能' }, { title: '职场新人', description: '将实习和学校项目转化为引人注目的工作经验' }, { title: '资深专业人士', description: '将20年经验浓缩为有效的2页简历' }, { title: '活跃求职者', description: '快速为每次投递创建定制简历' }] },
  faq: { title: '常见问题', items: [
    { question: '什么是AI简历制作？', answer: 'AI简历制作是在人工智能帮助下创建简历。我们的工具生成专业工作经验，优化ATS，建议行业关键词并自动排版——几分钟而非几小时就能完成完美简历。' },
    { question: 'AI简历比手动写作好吗？', answer: 'AI帮你更快写出更好的内容。它分析数千份成功简历，建议专业措辞、可衡量成果和适合职场的关键词。你保持对最终内容的完全控制——AI使过程更高效。' },
    { question: 'AI简历能通过ATS筛选吗？', answer: '可以！我们的AI简历制作器专门为ATS兼容性设计。AI格式化简历为机器可读的干净文本，建议匹配职位的关键词，并提供实时ATS评分以在投递前优化。' },
    { question: '这个AI简历工具免费吗？', answer: '是的，AI简历制作器100%免费。创建无限简历，使用所有模板，下载PDF——全部免费。无需信用卡或订阅。' },
    { question: 'AI如何生成内容？', answer: 'AI分析你的职位、行业和经验水平，生成个性化建议。它使用数百万份成功简历的模式来撰写专业摘要、以成果为导向的工作经验和吸引招聘人员的技能描述。' },
    { question: '我的简历看起来像AI写的吗？', answer: '不会。我们的工具生成自然、专业的内容，听起来像职业教练写的。你可以编辑每个建议添加个人风格，最终结果完全属于你。' },
  ] },
  crossLinks: { title: '其他AI简历工具', items: [{ href: '/zh/resume-maker', title: '简历制作器', subtitle: '免费AI简历制作器' }, { href: '/zh/tools/ats-checker', title: 'ATS检查器', subtitle: 'AI ATS分析' }, { href: '/zh/free-resume-builder', title: '免费简历', subtitle: '100%免费' }], guidesTitle: 'AI简历指南', guides: [{ href: '/zh/career-tips/ai-resume-tools', label: 'AI简历工具(2026)' }, { href: '/zh/blog/chatgpt-vs-claude-for-resumes', label: 'ChatGPT vs Claude: 哪个AI写简历更好？' }, { href: '/zh/career-tips/how-to-write-ats-friendly-resume', label: '如何制作ATS友好简历' }, { href: '/zh/resume-examples', label: '300+简历示例' }] },
  bottomCta: { title: '准备用AI创建简历？', description: '加入数百万求职者的行列，使用我们的<a href="/zh/" class="text-purple-600 hover:underline">AI简历制作器</a>获得更多面试机会。', cta: '免费开始使用AI', subtext: '永久免费。无需信用卡。' },
};

const ms: ResumeAIPageContent = {
  meta: { title: 'Buat Resume dengan AI | Penulisan Resume AI Percuma 2026', description: 'Buat resume dengan AI dalam beberapa minit. Alat resume AI percuma yang menulis kandungan profesional, mengoptimumkan untuk ATS dan membantu anda mendapat lebih banyak temu duga.', keywords: 'buat resume ai, penulisan resume ai, pembuat resume ai, resume kecerdasan buatan, resume ai percuma, pembuat resume pintar' },
  schemas: { breadcrumbName: 'Resume AI', articleHeadline: 'Buat Resume dengan AI: Pembuat Resume AI Percuma 2026', articleDescription: 'Buat resume dengan AI. Alat resume AI percuma kami menulis kandungan profesional, mengoptimumkan untuk ATS dan mencipta resume yang mendapat temu duga.', softwareAppName: 'Pembuat Resume AI' },
  hero: { badge: 'Dikuasakan AI Lanjutan', title: 'Cipta resume anda', titleHighlight: 'dengan AI dalam beberapa saat', subtitle: '<strong>Pembuat resume AI</strong> kami menulis kandungan profesional, mengoptimumkan untuk sistem ATS dan membantu anda mencipta resume yang mendapat temu duga — semuanya percuma. Menurut <a href="https://www.linkedin.com/business/talent/blog/talent-acquisition/how-recruiters-use-ai" target="_blank" rel="noopener noreferrer" class="text-purple-600 hover:underline">kajian LinkedIn</a>, perekrut menghabiskan purata hanya 7 saat pada setiap resume. Biarkan AI menjadikan setiap saat bermakna.', ctaPrimary: 'Cuba buat resume AI percuma', ctaSecondary: 'Lihat cara ia berfungsi', trustText: 'Tanpa akaun diperlukan \u00b7 100% percuma \u00b7 Kandungan dijana AI' },
  whatIs: { title: 'Apa itu membuat resume dengan AI?', description: '<strong>Membuat resume dengan AI</strong> mengubah secara asas cara anda menyediakan resume. Daripada merenung skrin kosong, AI kami menganalisis pengalaman anda, memahami jawatan sasaran anda dan menjana kandungan profesional yang disesuaikan untuk industri anda. Seperti yang ditekankan oleh <a href="https://www.shrm.org/topics-tools/news/talent-acquisition/ai-rapidly-transforming-how-companies-recruit" target="_blank" rel="noopener noreferrer" class="text-purple-600 hover:underline">Society for Human Resource Management (SHRM)</a>, AI sedang mengubah perekrutan dengan pantas — dan resume yang dibuat dengan AI diterima secara meluas oleh majikan.', stats: [{ value: '10x', label: 'Lebih pantas daripada menulis manual' }, { value: '85%', label: 'Peluang lebih tinggi melepasi ATS' }, { value: '3M+', label: 'Resume dicipta dengan AI' }] },
  features: { title: 'Bagaimana AI menambah baik resume anda', subtitle: 'AI lebih daripada sekadar format — ia membantu anda menulis kandungan yang benar-benar lebih baik.', items: [{ title: 'Penulisan kandungan AI', description: 'AI menjana pengalaman kerja profesional, ringkasan dan penerangan kemahiran berdasarkan pengalaman dan jawatan sasaran anda.' }, { title: 'Pengoptimuman kata kunci pintar', description: 'AI menganalisis deskripsi kerja dan mencadangkan kata kunci khusus industri yang dicari majikan.' }, { title: 'Analisis skor ATS', description: 'Penilaian masa nyata menunjukkan bagaimana resume anda dinilai oleh sistem ATS sebelum anda memohon.' }, { title: 'Mengukur pencapaian', description: 'AI menukar penerangan kabur menjadi pencapaian yang boleh diukur dan konkrit yang menarik perhatian perekrut.' }, { title: 'Templat khusus industri', description: 'AI mencadangkan susun atur dan seksyen yang paling sesuai untuk industri dan tahap pengalaman anda.' }, { title: 'Semakan tatabahasa & nada', description: 'AI menyemak tatabahasa dan ejaan secara automatik untuk persembahan profesional tanpa kesilapan.' }] },
  beforeAfter: { title: 'Lihat bagaimana AI mengubah resume anda', subtitle: 'Contoh sebenar penambahbaikan oleh kecerdasan buatan.', beforeLabel: 'Sebelum', afterLabel: 'Selepas AI', items: [{ before: 'Mengurus pasukan dan projek', after: 'Memimpin pasukan silang fungsi 8 orang; menyiapkan 12 projek tepat pada masanya dengan kepuasan pelanggan 98%' }, { before: 'Meningkatkan hasil', after: 'Meningkatkan hasil tahunan sebanyak 34% (RM280K) melalui strategi perolehan berdasarkan data' }, { before: 'Memberikan perkhidmatan pelanggan yang baik', after: 'Skor kepuasan 4.9/5; mengendalikan 150+ pertanyaan harian dengan kadar penyelesaian hubungan pertama 95%' }], cta: 'Cipta resume profesional' },
  comparison: { title: 'Resume AI vs. resume ditulis manual', subtitle: 'Mengapa pencari kerja memilih membuat resume dengan AI.', oursName: 'Dengan AI', othersName: 'Manual', rows: [{ feature: 'Masa pembuatan', ours: '10-15 minit', others: '2-4 jam' }, { feature: 'Penulisan profesional', ours: 'AI mencadangkan', others: 'Perlu kajian sendiri' }, { feature: 'Pengoptimuman ATS', ours: 'Automatik', others: 'Manual, mudah silap' }, { feature: 'Kata kunci industri', ours: 'Cadangan AI', others: 'Cari sendiri' }, { feature: 'Tatabahasa/ejaan', ours: 'Semakan automatik', others: 'Mudah terlepas' }, { feature: 'Mengukur pencapaian', ours: 'AI membantu', others: 'Sering terlupa' }, { feature: 'Format/reka bentuk', ours: '20+ templat', others: 'Bina dari kosong' }] },
  useCases: { title: 'Untuk siapa resume AI?', subtitle: 'Pembuat resume AI kami sesuai untuk semua pencari kerja.', items: [{ title: 'Bertukar kerjaya', description: 'AI membantu menonjolkan kemahiran yang boleh dipindahkan' }, { title: 'Baru memasuki pasaran kerja', description: 'Tukar latihan amali dan projek pelajar kepada pengalaman kerja yang menarik' }, { title: 'Profesional berpengalaman', description: 'Ringkaskan 20 tahun pengalaman dalam resume 2 halaman yang berkesan' }, { title: 'Aktif memohon kerja', description: 'Cipta resume tersuai dengan cepat untuk setiap permohonan' }] },
  faq: { title: 'Soalan lazim', items: [
    { question: 'Apa itu membuat resume dengan AI?', answer: 'Membuat resume dengan AI bermaksud menyediakan resume dengan bantuan kecerdasan buatan. Alat kami menjana pengalaman kerja profesional, mengoptimumkan untuk ATS, mencadangkan kata kunci industri dan memformat semuanya secara automatik — resume sempurna dalam minit, bukan jam.' },
    { question: 'Adakah resume AI lebih baik daripada resume ditulis manual?', answer: 'AI membantu anda menulis kandungan lebih baik dengan lebih pantas. Ia menganalisis beribu resume berjaya dan mencadangkan frasa profesional, pencapaian boleh diukur dan kata kunci yang sesuai dengan pasaran kerja. Anda mengekalkan kawalan penuh — AI menjadikan proses lebih berkesan.' },
    { question: 'Bolehkah resume AI melepasi penapis ATS?', answer: 'Ya! Pembuat resume AI kami direka khas untuk keserasian ATS. AI memformat resume dengan teks bersih yang mudah dibaca, mencadangkan kata kunci yang sepadan dan memberikan skor ATS masa nyata untuk mengoptimumkan sebelum menghantar.' },
    { question: 'Adakah alat resume AI ini percuma?', answer: 'Ya, pembuat resume AI 100% percuma. Cipta resume tanpa had, guna semua templat, muat turun sebagai PDF — semuanya percuma. Tanpa kad kredit atau langganan diperlukan.' },
    { question: 'Bagaimana AI menjana kandungan?', answer: 'AI menganalisis jawatan, industri dan tahap pengalaman anda untuk menjana cadangan terperibadi. Ia menggunakan corak daripada jutaan resume berjaya untuk menulis ringkasan profesional, pengalaman kerja berorientasikan pencapaian dan penerangan kemahiran yang menarik perekrut.' },
    { question: 'Adakah resume saya kelihatan seperti ditulis AI?', answer: 'Tidak. Alat kami menjana kandungan profesional semula jadi yang kedengaran seperti ditulis oleh jurulatih kerjaya. Anda boleh mengedit setiap cadangan untuk menambah sentuhan peribadi, dan hasil akhir sepenuhnya milik anda.' },
  ] },
  crossLinks: { title: 'Alat resume AI lain', items: [{ href: '/ms/resume-maker', title: 'Pembuat Resume', subtitle: 'Pembuat resume AI percuma' }, { href: '/ms/tools/ats-checker', title: 'Penyemak ATS', subtitle: 'Analisis ATS AI' }, { href: '/ms/free-resume-builder', title: 'Resume Percuma', subtitle: '100% percuma' }], guidesTitle: 'Panduan resume AI', guides: [{ href: '/ms/career-tips/ai-resume-tools', label: 'Alat AI untuk resume (2026)' }, { href: '/ms/blog/chatgpt-vs-claude-for-resumes', label: 'ChatGPT vs Claude: AI mana untuk resume?' }, { href: '/ms/career-tips/how-to-write-ats-friendly-resume', label: 'Cara buat resume mesra ATS' }, { href: '/ms/resume-examples', label: '300+ contoh resume' }] },
  bottomCta: { title: 'Bersedia membuat resume dengan AI?', description: 'Sertai jutaan pencari kerja yang mendapat lebih banyak temu duga — dengan <a href="/ms/" class="text-purple-600 hover:underline">pembuat resume AI</a> kami.', cta: 'Mula percuma dengan AI', subtext: 'Percuma selama-lamanya. Tanpa kad kredit.' },
};

const contentMap: Record<string, ResumeAIPageContent> = { en, es, fr, de, ar, ja, it, vi, ko, th, pt, tr, id, pl, nl, zh, ms };
