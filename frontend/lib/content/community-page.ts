...
const zh: CommunityContent = {
  title: '社区模板',
  subtitle: '浏览和使用社区分享的模板',
  categories: [
    { value: '', label: '全部' },
    { value: 'professional', label: '专业' },
    { value: 'creative', label: '创意' },
    { value: 'ats', label: 'ATS友好' },
    { value: 'bold', label: '大胆' },
  ],
  browseTab: '浏览模板',
  myTemplatesTab: '我的模板',
  templatesAvailable: '{count} 个可用模板',
  templateAvailable: '{count} 个可用模板',
  createYourOwn: '创建你自己的 \u2192',
  errorMessage: '加载模板失败，请重试。',
  tryAgain: '重试',
  noTemplatesTitle: '暂无模板',
  noTemplatesSub: '成为第一个与社区分享模板的人！',
  createTemplate: '创建模板',
  pageOf: '第 {page} 页 / 共 {total} 页',
  templatesPosted: '已发布 {count} 个模板',
  templatePosted: '已发布 {count} 个模板',
  createNewTemplate: '创建新模板 \u2192',
  noPostedTitle: '你还没有发布模板',
  noPostedSub: '在画布编辑器中创建设计，然后分享给社区！',
  publicLabel: '公开',
  privateLabel: '私密',
  noPreview: '无预览',
  downloads: '次下载',
  download: '次下载',
  signInTitle: '登录查看你的模板',
  signInSub: '你需要登录才能查看和管理已发布的模板。',
  signIn: '登录',
  deleteConfirm: '确定要删除此模板吗？此操作无法撤销。',
  deleteError: '删除模板失败，请重试。',
  visibilityError: '更新可见性失败，请重试。',
  makePrivate: '设为私密',
  makePublic: '设为公开',
  edit: '编辑',
  deleteBtn: '删除',
...
const ms: CommunityContent = {
  title: 'Templat Komuniti',
  subtitle: 'Layari dan gunakan templat yang dikongsi oleh komuniti',
  categories: [
    { value: '', label: 'Semua' },
    { value: 'professional', label: 'Profesional' },
    { value: 'creative', label: 'Kreatif' },
    { value: 'ats', label: 'Mesra ATS' },
    { value: 'bold', label: 'Berani' },
  ],
  browseTab: 'Layari Templat',
  myTemplatesTab: 'Templat Saya',
  templatesAvailable: '{count} templat tersedia',
  templateAvailable: '{count} templat tersedia',
  createYourOwn: 'Cipta sendiri \u2192',
  errorMessage: 'Gagal memuatkan templat. Sila cuba lagi.',
  tryAgain: 'Cuba Lagi',
  noTemplatesTitle: 'Belum ada templat',
  noTemplatesSub: 'Jadilah yang pertama berkongsi templat dengan komuniti!',
  createTemplate: 'Cipta Templat',
  pageOf: 'Halaman {page} daripada {total}',
  templatesPosted: '{count} templat dihantar',
  templatePosted: '{count} templat dihantar',
  createNewTemplate: 'Cipta templat baharu \u2192',
  noPostedTitle: 'Belum ada templat dihantar',
  noPostedSub: 'Cipta reka bentuk dalam editor kanvas dan kongsi dengan komuniti!',
  publicLabel: 'Awam',
  privateLabel: 'Peribadi',
  noPreview: 'Tiada pratonton',
  downloads: 'muat turun',
  download: 'muat turun',
  signInTitle: 'Log masuk untuk melihat templat anda',
  signInSub: 'Anda perlu log masuk untuk melihat dan mengurus templat yang dihantar.',
  signIn: 'Log Masuk',
  deleteConfirm: 'Adakah anda pasti mahu memadamkan templat ini? Tindakan ini tidak boleh dibatalkan.',
  deleteError: 'Gagal memadamkan templat. Sila cuba lagi.',
  visibilityError: 'Gagal mengemaskini keterlihatan. Sila cuba lagi.',
  makePrivate: 'Jadikan Peribadi',
  makePublic: 'Jadikan Awam',
  edit: 'Edit',
  deleteBtn: 'Padam',
};

const contentMap: Record<string, CommunityContent> = { en, es, fr, de, ar, ja, it, ko, vi, th, pt, tr, id, pl, nl, zh, ms };
