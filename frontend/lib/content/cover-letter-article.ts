...
const pt: CoverLetterArticleContent = {
  breadcrumb: { home: 'Início', coverLetterExamples: 'Exemplos de Carta de Apresentação' },
  notFound: 'Não Encontrado',
  coverLetterSuffix: 'Exemplo de Carta de Apresentação',
  keySkillsTitle: 'Habilidades-Chave a Destacar',
  relatedTopics: 'Tópicos Relacionados',
  faqTitle: 'Perguntas Frequentes',
  relatedResourcesTitle: 'Recursos Relacionados',
  resumeExampleSubtext: 'Confira o formato de currículo correspondente',
  coverLetterGenerator: 'Gerador de Carta de Apresentação com IA',
  coverLetterGeneratorSubtext: 'Crie sua carta de apresentação em segundos',
  sidebar: {
    ctaTitle: 'Crie Sua Carta de Apresentação',
    ctaSubtitle: 'Use nossa IA para gerar uma carta de apresentação personalizada para {jobTitle} em segundos.',
    ctaButton: 'Gerar Carta de Apresentação',
    tocTitle: 'Índice',
  },
  relatedCoverLetters: 'Cartas de Apresentação Relacionadas',
  bottomCta: {
    subtitle: 'Junte-se a milhares de profissionais que encontraram o emprego dos sonhos com a Best AI Resume.',
    button: 'Gerar Carta de Apresentação — Grátis',
  },
  updated: 'Atualizado',
};
