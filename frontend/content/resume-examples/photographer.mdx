...
### "Your gear fails mid-shoot — a body dies or a card corrupts at a wedding. What's your plan?"

There are no reshoots for live events, so redundancy is everything. Describe how you carry backup bodies, dual card slots writing simultaneously, spare batteries, and a tested file-offload routine. Walk through a real moment where a backup saved the shoot. This question screens out hobbyists who don't plan for failure on irreplaceable moments.

### "How do you light a scene in a difficult location — a dim reception hall or harsh midday sun?"

Lighting command is the heart of the craft. Talk through your approach: reading available light, when you bounce or use off-camera flash and modifiers, how you balance ambient and strobe, and how you adapt fast when a venue surprises you. Specifics about modifiers, light shaping, and metering prove you control light rather than hoping for it.

### "Walk me through your editing and culling workflow and your delivery turnaround."

Clients buy the finished product, not the click. Describe your pipeline — import and backup, culling, color and retouching in Lightroom or Capture One, export, and delivery via online galleries. Give your realistic turnaround (e.g., 48-hour previews, full gallery in two weeks) and how you keep it consistent under volume. Reliable delivery is what earns referrals.

### "How do you direct a nervous or non-professional subject to get natural shots?"

Most portrait and event subjects aren't models. Explain how you build rapport, give clear posing cues, use prompts that create real reactions, and keep energy up so people relax. An example of turning a stiff client into genuine images shows you understand that people skills, not just camera skills, produce sellable work.

### "How do you handle pricing, contracts, and a client who's unhappy with the final images?"

The business side decides whether a photographer survives. Discuss how you structure pricing and packages, use contracts and model releases, and handle a dispute professionally — listening, offering reasonable revisions within scope, and protecting your usage rights. Showing business maturity reassures studios and agencies you won't create legal or reputation risk.
