...
### "A guest tells you they have a severe nut allergy — walk me through exactly what you do."

This is a safety question, and a vague answer can end the interview. Describe taking the allergy seriously, repeating it back, flagging it on the ticket, telling the kitchen directly (not just typing it into the POS), and checking with a chef about hidden ingredients and cross-contamination risk before recommending dishes. Mention confirming the plate when it comes up and never guessing. Hiring managers need to trust you won't put a guest in the hospital, so show you treat allergies as non-negotiable.

### "How do you time courses so a table of eight isn't waiting on each other's food?"

Full-service waiting is really about coordination with the kitchen, so they're testing your timing instincts. Explain how you fire appetizers and entrées in sequence, communicate large-party timing to expo, hold or push a course when the table's pace changes, and make sure everyone at the table is served together. Reference reducing ticket times or coordinating multi-course service. They want a server who reads the table and the window at the same time.

### "Describe how you'd handle a section of six tables all seated within a few minutes of each other."

Getting triple- or quadruple-sat is the reality of the floor, so this checks your prioritization. Walk through your opening moves: greet every new table within a minute even if it's just water and 'I'll be right back,' take drink orders by urgency, and use a tray-jack and pre-bussing to avoid extra trips. Mention leaning on a food runner or busser and never letting a table go un-greeted. Managers want to see you stay organized and warm when everything hits at once.

### "Tell me about coordinating service for a large party or private event."

Many full-service restaurants book parties and banquets, so they value a server who can handle them. Talk through confirming the headcount and any set menu, splitting or pre-printing checks, staging courses for a big top, and keeping one point of contact with the host. Mention coordinating timing with the kitchen so 30 entrées land hot and together. A concrete example — a 40-guest event you ran with zero complaints — lands far better than a general answer.

### "What's your process for splitting a complicated check at the end of the night?"

Billing accuracy protects the restaurant and keeps tables turning, so this is a practical screen. Explain how you track who ordered what as the meal goes, use the POS to split items or seats cleanly, double-check the math before dropping it, and handle separate cards and shared items without making guests wait. Note staying patient and friendly even when a table wants it split six ways. They want someone who closes out fast and correctly so the next party can be seated.
