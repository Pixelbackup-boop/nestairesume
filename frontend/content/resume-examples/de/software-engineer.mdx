...
authorBio: >-
  ...
  Personalvermittlung für Technologieunternehmen im DACH-Raum. Spezialisiert auf
  Bewerbungsunterlagen für Softwareentwickler und IT-Fachkräfte.
...
faq:
  - question: >-
      ...
      aufnehmen?
    answer: >-
      Nennen Sie konkrete Programmiersprachen und Frameworks (z. B. Java,
      Python, TypeScript, React), Cloud-Plattformen (AWS, Azure, GCP) und
      Methodiken wie Scrum oder Kanban. Ergänzen Sie Soft Skills wie
      Teamfähigkeit und strukturiertes Denken — und passen Sie den Lebenslauf an
      jede Stellenausschreibung an, da ATS-Systeme exakte Schlüsselwörter
      suchen.
