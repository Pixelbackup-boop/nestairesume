---
title: 'How to Use ChatGPT to Write Your Resume (Prompts + Examples)'
...
faq:
  ...
  - question: Is it okay to use ChatGPT to write a resume?
    answer: >-
      ...
      increasingly common. The key is to use ChatGPT as a writing assistant,
      not to fabricate experience. All claims in your resume should be
      accurate and represent your actual work. Using AI to improve how you
      describe real experience is legitimate and effective.
  - question: What are the best ChatGPT prompts for resume writing?
    answer: >-
      The most effective prompts are specific: provide the job description
      you are targeting, your existing experience details, and specify the
      output format you want. Vague prompts produce generic output. Specific
      prompts that include context about your industry, role level, and target
      role produce much more useful results.
  - question: Can ChatGPT help me tailor my resume to a specific job?
    answer: >-
      ...
      rewrite your summary to match the role's priorities. This process used
      to take 45-60 minutes manually; with ChatGPT it takes 10-15 minutes.
  - question: Will ChatGPT resumes get caught by ATS?
    answer: >-
      ...
      generic resumes perform poorly with ATS because they do not match
      specific job descriptions. The solution is to prompt specifically
      for your target role and always customize.
...
## When ChatGPT Helps Most (and Least)
...
Before using any of the specific prompts below, set up context with a master prompt at the start of your conversation:
