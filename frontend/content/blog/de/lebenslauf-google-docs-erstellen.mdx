...
faq:
  - question: Sind Google Docs Lebenslauf-Vorlagen wirklich kostenlos?
    answer: >-
      Ja, alle integrierten Lebenslauf-Vorlagen in Google Docs sind vollständig
      kostenlos. Sie benötigen nur ein Google-Konto. Es gibt keine versteckten
      Kosten, Premium-Versionen oder Wasserzeichen. Allerdings ist die Auswahl
      mit fünf bis sechs Vorlagen deutlich kleiner als bei spezialisierten
      Lebenslauf-Buildern.
  - question: Kann ich in Google Docs ein Bewerbungsfoto einfügen?
    answer: >-
      Ja, über Einfügen > Bild können Sie ein Foto hinzufügen. Für die typische
      Positionierung oben rechts nutzen Sie die Option ''Text umbrechen'' und
      ziehen das Bild an die gewünschte Stelle. Empfohlene Größe für deutsche
      Bewerbungen: 3,5 x 4,5 cm. Achten Sie auf eine Auflösung von mindestens
      300 dpi.
  - question: Ist ein Google Docs Lebenslauf ATS-kompatibel?
    answer: >-
      ...
      erzeugt beim PDF-Export echte Textebenen, was ATS-Systeme lesen können.
      Probleme entstehen bei komplexen Tabellenlayouts, eingebetteten Bildern
      und ungewöhnlichen Formatierungen. Einfache, einspaltige Layouts
  ...
  - question: Kann ich den Google Docs Lebenslauf als PDF exportieren?
    answer: >-
      ...
      empfohlene Weg für Bewerbungen. Sie können auch als Word-Datei (.docx)
      exportieren, wenn ein Unternehmen das explizit verlangt. Prüfen Sie nach
      dem Export die Formatierung, da bei der Konvertierung Abstände und
      Schriftarten leicht verschoben werden können.
  - question: Kann ich meinen Google Docs Lebenslauf auf dem Smartphone bearbeiten?
    answer: >-
      Ja, die Google Docs App ist für iOS und Android verfügbar. Für kleinere
      Korrekturen (Tippfehler, Datumsänderungen) ist die mobile Bearbeitung
      geeignet. Für die erstmalige Erstellung empfehle ich jedoch einen
      Desktop-Computer, da die Formatierungsmöglichkeiten am Smartphone
      eingeschränkt sind.
  - question: Wie teile ich meinen Lebenslauf aus Google Docs zur Korrektur?
    answer: >-
      ...
      Anmerkungen hinterlassen, ohne den Text zu verändern. Für vertrauliche
      Bewerbungen nutzen Sie die Option ''Bestimmte Personen'' statt ''Jeder mit
      dem Link''.
  - question: >-
      Welche Schriftarten empfehlen sich für einen deutschen Lebenslauf in
      Google Docs?
    answer: >-
      ...
      Vermeiden Sie dekorative Schriften wie Comic Sans, Pacifico oder Lobster.
      Google Docs bietet über 1.000 Schriften, von denen sich etwa 20 für
      Bewerbungen eignen.
---
