...
faq:
  - question: Why do interviewers ask about your greatest weakness?
    answer: >-
      Interviewers want to assess self-awareness, honesty, and growth mindset.
      They're not trying to disqualify you—they're checking if you can reflect
      on areas for improvement and take action to address them.
  - question: Should I give a real weakness or a fake one?
    answer: >-
      Give a real but strategic weakness. Fake weaknesses ("I work too hard")
      are transparent and suggest you lack self-awareness. Choose a genuine area
      you're actively improving that won't disqualify you from the role.
  - question: What weaknesses should I never mention in an interview?
    answer: >-
      Never mention weaknesses that are core job requirements, character flaws
      (dishonesty, unreliability), or issues that suggest poor judgment. Also
      avoid "non-weaknesses" disguised as weaknesses—interviewers see through
      them.
  - question: How do I answer if I genuinely can't think of a weakness?
    answer: >-
      Everyone has areas for growth. Think about feedback you've received,
      skills you're developing, or situations where you felt less confident.
      Struggling to identify weaknesses might itself be a self-awareness issue
      to address.
  - question: Can I mention the same weakness in every interview?
    answer: >-
      You can use the same core weakness, but tailor it to each role. Ensure the
      weakness isn't critical for that specific position, and update your
      "improvement actions" to stay current.
  - question: How long should my weakness answer be?
    answer: >-
      Keep it to 60-90 seconds. State the weakness briefly (10-15 seconds),
      explain context (15-20 seconds), and focus most time on your improvement
      actions and progress (30-45 seconds).
