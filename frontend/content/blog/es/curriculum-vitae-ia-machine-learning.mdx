...
faq:
  - question: Que habilidades debo incluir en un curriculum de inteligencia artificial?
    answer: >-
      Las habilidades esenciales incluyen Python, TensorFlow, PyTorch, scikit-learn,
      SQL y estadistica avanzada. Agrega especializaciones como NLP, vision por
      computadora o MLOps segun el rol. Incluye plataformas cloud como AWS SageMaker
      o GCP Vertex AI, herramientas de datos como Spark y Airflow, y herramientas de
      seguimiento de experimentos como MLflow y Weights and Biases.
  - question: Como debo listar proyectos de machine learning en mi curriculum?
    answer: >-
      Formatea cada proyecto con nombre, stack tecnologico y fecha. Usa 2-3 puntos
      cubriendo el problema resuelto, el enfoque tomado (tipo de modelo, tamano del
      dataset) y el resultado medible (precision, latencia, impacto de negocio).
      Incluye enlaces a repositorios de GitHub, papers o demos cuando sea posible.
  - question: Necesito un doctorado para trabajar en inteligencia artificial?
    answer: >-
      No necesariamente. Aunque algunos roles de investigacion prefieren doctorado,
      muchas posiciones de ML engineer y IA aplicada aceptan maestria o incluso
      licenciatura con experiencia solida en proyectos. Las habilidades practicas,
      modelos desplegados y experiencia en produccion suelen importar mas que las
      credenciales academicas para roles en la industria.
  - question: Vale la pena incluir competencias de Kaggle en mi CV de IA?
    answer: >-
      Si, especialmente si obtuviste una buena clasificacion. Las competencias de
      Kaggle demuestran habilidades practicas de ML y capacidad para resolver
  ...
  - question: Que palabras clave ATS son importantes para un curriculum de IA y ML?
    answer: >-
      ...
      redes neuronales, NLP, vision por computadora, Python, TensorFlow, PyTorch,
      scikit-learn, despliegue de modelos, MLOps, A/B testing, feature engineering,
      entrenamiento de modelos, optimizacion de inferencia y plataformas cloud ML
      como AWS SageMaker, GCP Vertex AI y Azure ML.
  - question: Como adapto mi curriculum de IA para diferentes tipos de roles?
    answer: >-
      ...
      Data Scientist, destaca impacto de negocio y comunicacion con stakeholders.
      Para investigador, prioriza publicaciones y contribuciones metodologicas. Cada
      version debe tener un resumen profesional diferente alineado con el puesto.
  - question: Debo incluir publicaciones academicas en mi CV de machine learning?
    answer: >-
      ...
      expertise. Incluye papers peer-reviewed con la citacion completa, charlas en
      conferencias con nombre y ano, y contribuciones a proyectos open source
...
Nuestro [creador de curriculum con IA](/es/builder) te ayuda a crear un curriculum tecnico detallado optimizado para sistemas ATS. Identifica las palabras clave correctas para tu rol objetivo y formatea tus proyectos y experiencia para maximo impacto. Empieza con una [plantilla gratuita](/es/templates) disenada para profesionales tecnicos.
