...
description: >-
  ...
  net, avantages et techniques pour obtenir la rémunération que vous méritez en
  2026.
date: '2026-02-21'
...
faq:
  - question: Faut-il négocier son salaire lors d'un premier emploi en France ?
    answer: >-
      ...
      plus limitée (5 à 10 % maximum), surtout dans les grandes entreprises où
      les grilles salariales sont rigides. Renseignez-vous sur les salaires
      d'entrée de votre école ou université et de votre secteur via l'APEC ou
      l'enquête d'insertion de votre établissement. Négociez en priorité les
      avantages : télétravail, formation, tickets restaurant.
  - question: Quand faut-il aborder la question du salaire en entretien ?
    answer: >-
      ...
      contact, donnez une fourchette large basée sur vos recherches. Évitez de
      donner un chiffre fixe trop tôt — cela réduit votre marge de manœuvre. En
      France, la question arrive souvent dès le premier entretien RH, soyez donc
      toujours préparé.
  - question: Comment calculer son salaire net à partir du brut en France ?
    answer: >-
      ...
      estimation rapide, multipliez votre brut annuel par 0,75 (cadre) ou 0,78
      (non-cadre) pour obtenir votre net annuel avant impôt sur le revenu.
      Depuis 2019, le prélèvement à la source ajoute une déduction
  ...
  - question: La négociation salariale est-elle mal vue en France ?
    answer: >-
      ...
      sur des arguments émotionnels. La négociation fait partie du jeu et montre
  ...
  - question: Que faire si l'employeur dit que le salaire n'est pas négociable ?
    answer: >-
      ...
      jours de RTT supplémentaires, formation, voiture de fonction, prise en
      charge de la mutuelle. Ces avantages peuvent représenter 10 à 20 % de la
      valeur totale du package. Demandez aussi quand une révision salariale sera
      possible (fin de période d'essai, entretien annuel).
  - question: Comment négocier lors d'une mobilité interne ?
    answer: >-
      ...
      Appuyez-vous sur votre connaissance de l'entreprise, votre réseau interne
      et vos réalisations documentées. En France, les augmentations lors de
      mobilités internes sont généralement de 5 à 15 %. Si l'augmentation
      proposée est inférieure au marché externe, mentionnez-le factuellement.
      Votre manager actuel et le manager cible doivent tous deux valider le
      package.
  - question: Les conventions collectives imposent-elles un salaire minimum ?
    answer: >-
      Oui. En France, chaque branche professionnelle a une convention collective
      qui fixe des salaires minimums par niveau de qualification et
      d'ancienneté. Ces minimums sont souvent supérieurs au SMIC. Consultez la
      convention collective applicable à votre poste sur Légifrance pour
      connaître votre plancher salarial. Certaines conventions prévoient aussi
      des primes obligatoires (13e mois, ancienneté, vacances).
---
