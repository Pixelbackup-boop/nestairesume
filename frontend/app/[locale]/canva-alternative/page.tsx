            ...
            <section className="pt-32 pb-16 bg-gray-50">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold mt-4 mb-6 text-gray-900">
                        {c.hero.title}<br />
                        <span className="text-red-500">{c.hero.titleHighlight}</span>
                    </h1>
                    <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed"
                       dangerouslySetInnerHTML={{ __html: c.hero.subtitle }} />
                ...
                <div className="max-w-4xl mx-auto px-6">
                    <div className="bg-red-50 border border-red-200 rounded-2xl p-8 md:p-10">
                        ...
                        <p className="text-gray-700 mb-6 leading-relaxed"
                           dangerouslySetInnerHTML={{ __html: c.problem.description }} />
                        ...
                        {c.comparison.rows.map((row, i) => (
                            <div key={i} className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between items-start gap-2">
                                        <span className="text-accent-blue font-medium shrink-0">{c.comparison.oursName}:</span>
                ...
                <div className="max-w-5xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-blue-50 rounded-2xl p-8 border border-blue-100">
                            ...
                            <h3 className="font-bold text-xl mb-3 text-gray-900">{c.whySwitch.reasons[0]?.title}</h3>
                            <p className="text-gray-600 leading-relaxed">{c.whySwitch.reasons[0]?.description}</p>
                        </div>
                        ...
                        <div className="bg-green-50 rounded-2xl p-8 border border-green-100">
                            ...
                            <h3 className="font-bold text-xl mb-3 text-gray-900">{c.whySwitch.reasons[1]?.title}</h3>
                            <p className="text-gray-600 leading-relaxed">{c.whySwitch.reasons[1]?.description}</p>
                        </div>
                        ...
                        <div className="bg-purple-50 rounded-2xl p-8 border border-purple-100">
                            ...
                            <h3 className="font-bold text-xl mb-3 text-gray-900">{c.whySwitch.reasons[2]?.title}</h3>
                            <p className="text-gray-600 leading-relaxed">{c.whySwitch.reasons[2]?.description}</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto px-6">
                        ...
                        <div className="bg-blue-50 rounded-2xl p-8 border border-blue-200">
                            ...
                            <ul className="space-y-3 text-gray-700">
                                {c.recommendation.useUs.items.map((item, i) => (
                                    <li key={i} className="flex gap-3"><span className="text-accent-blue mt-0.5">&#10003;</span>{item}</li>
                                ))}
                            </ul>
                        </div>
                    </div>
                    ...
                    {c.recommendation.bottomLine && (
                        <p className="text-center text-gray-400 mt-8 text-sm">
                            <strong>{c.recommendation.bottomLine}</strong>
                        </p>
                    )}
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="grid sm:grid-cols-3 gap-3 mb-8">
                        {c.crossLinks.items.map((item, i) => (
                            <Link key={i} href={localizedHref(item.href)} className="p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition text-center">
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                        {c.crossLinks.guides.map((guide, i) => (
                            <Link key={i} href={localizedHref(guide.href)} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
