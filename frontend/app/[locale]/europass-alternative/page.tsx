...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        openGraph: { title: c.meta.title, description: c.meta.description, type: 'article', url: getLocalizedUrl(siteUrl, '/europass-alternative', locale) },
        twitter: { card: 'summary_large_image', title: c.meta.title, description: c.meta.description },
        alternates: { canonical: getLocalizedUrl(siteUrl, '/europass-alternative', locale), languages: alternateLanguages },
    };
}
...
export default async function EuropassAlternativePage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const articleSchema = {
        ...
        mainEntityOfPage: { '@type': 'WebPage', '@id': getLocalizedUrl(siteUrl, '/europass-alternative', locale) },
    };
