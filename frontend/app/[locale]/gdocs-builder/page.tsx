...
import { getGdocsTemplateById } from '@/lib/templates/gdocsTemplates';
    ...
    useEffect(() => {
        ...
        if (templateId) {
            ...
            if (gdocsTpl) {
                ...
                setTemplate(layoutMap[gdocsTpl.layout] || 'classic-normal-left');
            }
        }
            ...
            <div className="flex-1 flex flex-col min-w-0">
                <header className="bg-white/90 backdrop-blur-sm border-b border-gray-200 px-4 lg:px-6 py-3 flex items-center justify-between shrink-0 z-40">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <Download size={16} />
                            <span className="hidden sm:inline">Download for Google Docs</span>
                        </button>
                    </div>
                </header>
...
export default function GdocsBuilderPage() {
    return (
        <Suspense
            fallback={
                <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                    <div className="text-gray-500">Loading Google Docs builder...</div>
                </div>
            }
        >
            <GdocsBuilderContent />
