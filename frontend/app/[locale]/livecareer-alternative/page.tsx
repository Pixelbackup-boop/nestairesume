...
const alternateLanguages: Record<string, string> = { 'x-default': `${siteUrl}/en/livecareer-alternative` };
    locales.forEach((loc) => { alternateLanguages[loc] = `${siteUrl}/${loc}/livecareer-alternative`; });

    return {
        title: c.meta.title,
        description: c.meta.description,
        keywords: c.meta.keywords,
        openGraph: { title: c.meta.title, description: c.meta.description, type: 'article', url: `${siteUrl}/${locale}/livecareer-alternative` },
        twitter: { card: 'summary_large_image', title: c.meta.title, description: c.meta.description },
        alternates: { canonical: `${siteUrl}/${locale}/livecareer-alternative`, languages: alternateLanguages },
    };
}
...
export default async function LiveCareerAlternativePage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const articleSchema = {
        ...
        mainEntityOfPage: { '@type': 'WebPage', '@id': `${siteUrl}/${locale}/livecareer-alternative` },
    };
