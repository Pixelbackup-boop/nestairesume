      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <div className="feature-card-light rounded-2xl p-6 hover:shadow-xl transition-shadow">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-md hover:shadow-lg transition-shadow">
              <div className="mb-5">
                <h3 className="font-semibold text-lg mb-1 text-dark-teal">{tPricing("free.name")}</h3>
                <p className="text-dark-teal/60 text-xs">{tPricing("free.description")}</p>
              </div>
              <div className="mb-5">
                <span className="text-3xl font-bold text-dark-teal">{tPricing("free.price")}</span>
                <span className="text-dark-teal/60 text-sm">{tPricing("free.period")}</span>
              </div>
              <ul className="space-y-2.5 mb-6 text-sm">
                <li className="flex items-center gap-2 text-dark-teal/80">
                  ...
                  {tPricing("free.features.downloads")}
                </li>
                <li className="flex items-center gap-2 text-dark-teal/80">
                  <svg className="w-4 h-4 text-teal-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {tPricing("free.features.resumes")}
                </li>
                <li className="flex items-center gap-2 text-dark-teal/80">
                  <svg className="w-4 h-4 text-teal-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {tPricing("free.features.templates")}
                </li>
                <li className="flex items-center gap-2 text-dark-teal/80">
                  <svg className="w-4 h-4 text-teal-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {tPricing("free.features.aiBuild")}
                </li>
                <li className="flex items-center gap-2 text-dark-teal/40">
                  ...
                  {tPricing("free.limitations.ads")}
                </li>
              </ul>
              <Link href={localizedHref("/onboarding")} className="block w-full text-center py-2.5 rounded-lg border border-gray-300 hover:bg-gray-50 transition font-medium text-sm text-dark-teal">
                {tPricing("free.cta")}
              </Link>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-md hover:shadow-lg transition-shadow">
              ...
              <ul className="space-y-2.5 mb-6 text-sm">
                ...
                <li className="flex items-center gap-2 text-dark-teal/80">
                  <svg className="w-4 h-4 text-teal-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {tPricing("starter.features.resumes")}
                </li>
                <li className="flex items-center gap-2 text-dark-teal/80">
                  <svg className="w-4 h-4 text-teal-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                ...
                <li className="flex items-center gap-2 text-dark-teal/80">
                  <svg className="w-4 h-4 text-teal-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {tPricing("starter.features.export")}
                </li>
              </ul>
              <Link href={localizedHref("/pricing")} className="block w-full text-center py-2.5 rounded-lg border border-gray-300 hover:bg-gray-50 transition font-medium text-sm text-dark-teal">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-md hover:shadow-lg transition-shadow">
              ...
              <ul className="space-y-2.5 mb-6 text-sm">
                ...
                <li className="flex items-center gap-2 text-dark-teal/80">
                  <svg className="w-4 h-4 text-teal-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {tPricing("gold.features.resumes")}
                </li>
                <li className="flex items-center gap-2 text-dark-teal/80">
                  <svg className="w-4 h-4 text-teal-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
            ...
            <div className="bg-gradient-to-b from-teal-primary to-teal-secondary rounded-2xl p-5 relative shadow-xl">
              ...
              <ul className="space-y-2.5 mb-6 text-sm">
                ...
                <li className="flex items-center gap-2 text-white/90">
                  <svg className="w-4 h-4 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {tPricing("diamond.features.resumes")}
                </li>
                <li className="flex items-center gap-2 text-white/90">
                  <svg className="w-4 h-4 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  {tPricing("diamond.features.templates")}
                </li>
                <li className="flex items-center gap-2 text-white/90">
                  <svg className="w-4 h-4 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
              ...
              <Link href={localizedHref("/pricing")} className="block w-full text-center py-2.5 rounded-lg bg-white text-teal-primary font-semibold text-sm hover:bg-gray-50 transition">
          ...
          <p className="text-center text-dark-teal/60 text-sm mt-8">
            <Link href={localizedHref("/pricing")} className="text-teal-primary hover:underline">{tPricing("viewComparison")}</Link> • {tPricing("cancelAnytime")} • {tPricing("securePayments")}
          </p>
        </div>
      </section>
