...
const alternateLanguages: Record<string, string> = { 'x-default': `${siteUrl}/en/rezi-alternative` };
    ...
    return {
        ...
        openGraph: { title: c.meta.title, description: c.meta.description, type: 'article', url: `${siteUrl}/${locale}/rezi-alternative` },
        twitter: { card: 'summary_large_image', title: c.meta.title, description: c.meta.description },
        alternates: { canonical: `${siteUrl}/${locale}/rezi-alternative`, languages: alternateLanguages },
    };
}
...
export default async function ReziAlternativePage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const articleSchema = {
        ...
        mainEntityOfPage: { '@type': 'WebPage', '@id': `${siteUrl}/${locale}/rezi-alternative` },
    };
