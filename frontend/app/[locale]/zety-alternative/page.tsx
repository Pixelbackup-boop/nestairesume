...
const alternateLanguages: Record<string, string> = { 'x-default': `${siteUrl}/en/zety-alternative` };
    locales.forEach((loc) => { alternateLanguages[loc] = `${siteUrl}/${loc}/zety-alternative`; });

    return {
        title: c.meta.title,
        description: c.meta.description,
        keywords: c.meta.keywords,
        openGraph: { title: c.meta.title, description: c.meta.description, type: 'article', url: `${siteUrl}/${locale}/zety-alternative` },
        twitter: { card: 'summary_large_image', title: c.meta.title, description: c.meta.description },
        alternates: { canonical: `${siteUrl}/${locale}/zety-alternative`, languages: alternateLanguages },
    };
}
...
export default async function ZetyAlternativePage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const articleSchema = {
        ...
        mainEntityOfPage: { '@type': 'WebPage', '@id': `${siteUrl}/${locale}/zety-alternative` },
    };
