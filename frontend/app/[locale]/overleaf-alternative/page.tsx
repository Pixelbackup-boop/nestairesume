...
const alternateLanguages: Record<string, string> = { 'x-default': `${siteUrl}/en/overleaf-alternative` };
    locales.forEach((loc) => { alternateLanguages[loc] = `${siteUrl}/${loc}/overleaf-alternative`; });

    return {
        title: c.meta.title,
        description: c.meta.description,
        keywords: c.meta.keywords,
        openGraph: { title: c.meta.title, description: c.meta.description, type: 'article', url: `${siteUrl}/${locale}/overleaf-alternative` },
        twitter: { card: 'summary_large_image', title: c.meta.title, description: c.meta.description },
        alternates: { canonical: `${siteUrl}/${locale}/overleaf-alternative`, languages: alternateLanguages },
    };
}
...
export default async function OverleafAlternativePage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const articleSchema = {
        ...
        mainEntityOfPage: { '@type': 'WebPage', '@id': `${siteUrl}/${locale}/overleaf-alternative` },
    };
