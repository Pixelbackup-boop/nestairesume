...
export default function WordOnboardingPage() {
    ...
    const handleFinish = () => {
        router.push(localizedHref(`/word-builder?template=${formData.selectedTemplate}`));
    };
                ...
                {step === 1 && (
                    <div className="animate-fadeIn">
                        ...
                        <div className="text-center mt-10">
                            <Link
                                href={localizedHref('/word-builder')}
                ...
                {step === 4 && !isGenerating && (
                    <div className="animate-fadeIn">
                        ...
                        <div className="text-center mb-10">
                            ...
                            <h1 className="text-3xl font-bold mb-3">{t('word.step4Title')}</h1>
                            <p className="text-gray-500">
                                {t('word.step4Subtitle')}
                            </p>
                        </div>
