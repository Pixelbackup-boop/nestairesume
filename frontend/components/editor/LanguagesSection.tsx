                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none bg-bg-card-light border border-border-subtle rounded-md px-2 py-1 pr-7 text-xs text-gray-300 focus:outline-none focus:border-accent-green cursor-pointer"
                                >
