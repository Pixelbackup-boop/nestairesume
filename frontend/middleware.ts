...
const intlMiddleware = createMiddleware({
  ...
  // alternates for ALL 18 locales. Our page metadata already emits HTML
  // `<link rel="alternate" hreflang>` filtered to the 5 indexable locales; the
  // next-intl Link header (every configured locale, incl. noindexed ones)
  // conflicted with the HTML and pointed Google at noindexed-locale URLs. HTML
  // hreflang is now the single source of truth.
