...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      `connect-src 'self' ${process.env.NODE_ENV === 'development' ? 'http://localhost:4444' : ''} ${(process.env.NEXT_PUBLIC_API_URL || '').trim()} https://*.bestairesumes.com https://www.google-analytics.com https://embed.tawk.to https://va.tawk.to wss://chat.tawk.to https://api.stripe.com https://widget.trustpilot.com https://pagead2.googlesyndication.com`,
